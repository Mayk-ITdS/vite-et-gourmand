...
import { selectAverageRevenue, selectTotalRevenue } from "@/store/slices/adminSelectors";
...
const RevenueSummaryCard = () => {
  ...
  return (
    <div className="bg-[#1f2937] p-6 rounded-xl border border-white/10">
      ...
      <h3 className="text-2xl font-semibold mt-2">{totalRevenue.toLocaleString()} €</h3>
