...
const sections: SidebarSection[] = [
  {
    title: "Dashboard",
    items: [{ label: "Overview", path: "/employee" }],
  },
  {
    title: "Modération",
    items: [{ label: "Avis", path: "/employee/reviews" }],
  },
  {
    title: "Opérations",
    items: [{ label: "Réservations", path: "/employee/orders" }],
  },
];
  ...
  return (
    <aside className="w-72 h-screen shrink-0 border-r border-white/10 bg-slate-900/80 backdrop-blur-xl px-5 py-6">
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-white/50">Modération & opérations</p>
      </div>
